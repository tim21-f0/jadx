...
public class StringsTask extends CancelableBackgroundTask {
	...
	public StringsTask(MainWindow mainWindow, ExecutorService searchExecutor, Consumer<StringResult> resultsListener,
			BiConsumer<ITaskInfo, Boolean> onFinish) {
	...
	public synchronized void fetchResults() {
		...
		future = backgroundExecutor.executeOnWithFuture(searchExecutor, this);
	}
